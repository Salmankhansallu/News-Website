<?php include "header.php";
 ...
 // echo $pages;
 $_SESSION['page']=$pages;
if(isset($_SESSION['filesuploaderrormessage'])){
  echo $_SESSION['filesuploaderrormessage'];
  unset($_SESSION['filesuploaderrormessage']);
}
      ...
      ?>
        ...
        <form action="save-update-post.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <img  src="upload/<?php echo $row['post_img']; ?>" height="auto" width="100%" style="margin-top:15px;">
